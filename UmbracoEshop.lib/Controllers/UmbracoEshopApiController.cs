...
namespace UmbracoEshop.lib.Controllers
{
    ...
    public class UmbracoEshopApiController : _BaseApiController
    {
        // ~/UmbracoEshop/ContactFormApiKey
        public ApiKeyPair ContactFormApiKey()
        {
            return new ApiKeyValidator().GetNewKeyPair();
        }
    }
